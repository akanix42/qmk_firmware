...
,KC_RCTL   ,MEH_T(KC_NO),MO(RBASE),KC_RALT,KC_RGUI
                                             ,KC_LEFT ,KC_RGHT
                                                      ,KC_UP
                                    ,KC_SPC  ,KC_ENT  ,KC_DOWN
                                                                 ...
                                                                 ,LSFT(KC_TAB),KC_B   ,KC_V   ,KC_C   ,KC_X    ,KC_Z  ,KC_LSFT
                                                                                      ,KC_LGUI,KC_LALT,MO(RBASE),KC_MEH,KC_LCTL
                                                                 ,KC_HOME     ,KC_END
                                                                 ,KC_PGUP
...
[FPS] = LAYOUT_ergodox(
// left hand
 TO(BASE)  ,KC_1           ,KC_2   ,KC_3   ,KC_4  ,KC_5  ,KC_ESC
 ...
 * |------------+------+------+------+------+-------------|       |------+------+------+------+------+------+------------|
 * | Tab        |  F7  |  F8  |  F9  |  F10 |  F11 | F12  |       |      |  F1  |  F2  |  F3  |  F4  |  F12 | Pause/Break|
 * |------------+------+------+------+------+------|      |       |      |------+------+------+------+------+------------|
 * | Symbol     |   A  |   S  |   D  |   F  |   G  |------|       |------|   H  |   J  |   K  |   L  |   ;  | '"  Symbol |
 * |------------+------+------+------+------+------|Shift |       | Tab  |------+------+------+------+------+------------|
...
,KC_LCTL   ,MEH_T(KC_NO)   ,MO(RBASE),KC_LALT,KC_LGUI
                                 ...
                                 ,KC_BSPC,KC_DEL ,KC_PGDN
                                                                 ...
                                                                 ,KC_RBRC ,KC_F1,KC_F2          ,KC_F3  ,KC_F4  ,KC_F12           ,KC_PAUSE
                                                                          ,KC_H ,KC_J           ,KC_K   ,KC_L   ,KC_SCLN          ,F(RSymb)
                                                                 ,KC_TAB  ,KC_N ,KC_M           ,KC_COMM,KC_DOT ,KC_SLSH          ,KC_RSFT
                                                                                ,KC_RGUI        ,KC_RALT,MO(RBASE),KC_MEH           ,KC_RCTL
                                                                 ,KC_LEFT ,KC_RGHT
